...
(function (w, d) {
  ...
  function find(ref) {
    var apps = JS.getApps(), r = ref.trim().toUpperCase();
  ...
  function show(app) {
    ...
    $('#result').innerHTML =
      ...
      '<div class="tracker" style="--progress:0" id="tracker"><span class="tracker__bar"></span><span class="tracker__fill"></span>' +
      '<ol class="tracker__list">' + steps + '</ol></div>' +
  ...
  $('#result').addEventListener('click', function (e) {
    ...
    if (!b) return;
    var apps = JS.getApps(), app = apps.filter(function (a) { return a.ref === b.dataset.ref; })[0];
    if (app && app.status < 3) {
