...
(function (root, factory) {
  ...
  /* Sanity limits: no more than 120 years old; at most n digits */
  V.ageAtMost = function (iso, years, today) { return !V.ageAtLeast(iso, years + 1, today) && !isNaN(new Date(iso)); };
  V.maxDigits = function (v, n) { return String(v).replace(/,/g, '').trim().length <= n; };
